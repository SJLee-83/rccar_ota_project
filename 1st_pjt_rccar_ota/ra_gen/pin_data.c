...
const ioport_pin_cfg_t g_bsp_pin_cfg_data[] = { { .pin = BSP_IO_PORT_01_PIN_00,
		...
		BSP_IO_PORT_01_PIN_01, .pin_cfg = ((uint32_t) IOPORT_CFG_DRIVE_MID
		| (uint32_t) IOPORT_CFG_PERIPHERAL_PIN
		| (uint32_t) IOPORT_PERIPHERAL_SPI) }, { .pin = BSP_IO_PORT_01_PIN_02,
		...
		BSP_IO_PORT_04_PIN_00, .pin_cfg = ((uint32_t) IOPORT_CFG_DRIVE_MID
		| (uint32_t) IOPORT_CFG_PERIPHERAL_PIN
